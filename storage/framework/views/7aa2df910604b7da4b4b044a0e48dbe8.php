    ...
    <div class="split-layout">
        ...
        <div class="left-panel">
            <div class="header-bar fade-in-up">
                ...
                <div class="nav-text">
                    New user? <a href="<?php echo e(route('register')); ?>" class="nav-link">Create an account</a>
                </div>
            </div>
            ...
            <div class="form-wrapper fade-in-up delay-1">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="input-group-gap">
                        ...
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control" placeholder="name@example.com" required autofocus>
                    </div>
                    ...
                    <div class="form-actions">
                        <div class="form-check d-flex align-items-center gap-2">
                            <input type="checkbox" name="remember" id="remember" class="form-check-input mt-0" <?php echo e(old('remember') ? 'checked' : ''); ?> style="cursor:pointer; border-color: #cbd5e1;">
        ...
        <div class="right-panel">
            ...
            <div class="showcase-content">
                <div class="preview-image-container fade-in-up delay-1">
                    <img src="<?php echo e(asset('images/dashboard-preview.png')); ?>" alt="SmartHome Dashboard" class="preview-image" data-tilt data-tilt-max="5" data-tilt-speed="400" data-tilt-glare="true" data-tilt-max-glare="0.3">
                </div>
...
<?php /**PATH C:\Users\satya\OneDrive\Desktop\IOT-DASHBOARD\resources\views/auth/login.blade.php ENDPATH**/ ?>
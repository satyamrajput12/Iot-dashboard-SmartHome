...
<aside class="sidebar" id="sidebar">
    <a href="<?php echo e(auth()->user()->isAdmin() ? route('admin.dashboard') : route('user.dashboard')); ?>" class="sidebar-brand">
    ...
    <nav class="sidebar-nav">
        <?php if(auth()->user()->isAdmin()): ?>
            ...
            <a href="<?php echo e(route('admin.devices')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.devices') ? 'active' : ''); ?>">
        ...
        <?php else: ?>
            ...
            <a href="<?php echo e(route('user.rooms.index')); ?>" class="nav-link <?php echo e(request()->routeIs('user.rooms.*') ? 'active' : ''); ?>">
                <i class="bi bi-grid-1x2"></i> Rooms
            </a>
            <a href="<?php echo e(route('user.devices.index')); ?>" class="nav-link <?php echo e(request()->routeIs('user.devices.*') ? 'active' : ''); ?>">
                <i class="bi bi-cpu"></i> My Devices
            </a>
            <div class="nav-section-label">Analytics & Account</div>
            <a href="<?php echo e(route('user.energy.index')); ?>" class="nav-link <?php echo e(request()->routeIs('user.energy.*') ? 'active' : ''); ?>">
                <i class="bi bi-lightning-charge"></i> Energy
            </a>
            <a href="<?php echo e(route('user.billing.index')); ?>" class="nav-link <?php echo e(request()->routeIs('user.billing.*') ? 'active' : ''); ?>">
    ...
    <div style="padding:1rem 1.25rem;border-top:1px solid rgba(255,255,255,.08)">
        <div style="display:flex;align-items:center;gap:.75rem">
            ...
            <div style="position:relative; width:40px; height:40px;">
                <img src="<?php echo e(auth()->user()->profile_photo_url); ?>" alt="Profile" style="width:100%; height:100%; border-radius:50%; object-fit:cover; border: 2px solid var(--primary); cursor:pointer;" onclick="document.getElementById('profilePhotoInput').click()">
                <form id="profilePhotoForm" action="<?php echo e(route('user.profile.photo')); ?>" method="POST" enctype="multipart/form-data" style="display:none;">
                    <?php echo csrf_field(); ?>
            ...
            <div style="flex:1;overflow:hidden">
                <div style="color:#fff;font-size:.85rem;font-weight:500;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"><?php echo e(auth()->user()->name); ?></div>
                <div style="color:#a5b4fc;font-size:.72rem"><?php echo e(ucfirst(auth()->user()->role)); ?></div>
            </div>
...
<div class="main-content">
    ...
    <div class="topbar">
        ...
        <div style="display:flex;align-items:center;gap:1rem">
            ...
            <?php if(auth()->user()->isAdmin()): ?>
                <?php $pendingCount = \App\Models\Device::where('approval_status','pending')->count(); ?>
                <?php if($pendingCount > 0): ?>
                    <a href="<?php echo e(route('admin.devices')); ?>?approval=pending" class="btn btn-sm btn-warning" style="font-size:.8rem">
                        <i class="bi bi-shield-exclamation me-1"></i><?php echo e($pendingCount); ?> Pending
                    </a>
                <?php endif; ?>
            <?php endif; ?>
...
<div class="bottom-nav d-lg-none">
    <a href="<?php echo e(route('user.dashboard')); ?>" class="bottom-nav-item <?php echo e(request()->routeIs('user.dashboard') ? 'active' : ''); ?>">
        <i class="bi bi-house"></i> Home
    </a>
    <a href="<?php echo e(route('user.rooms.index')); ?>" class="bottom-nav-item <?php echo e(request()->routeIs('user.rooms.*') ? 'active' : ''); ?>">
        <i class="bi bi-grid"></i> Rooms
    </a>
    <a href="<?php echo e(route('user.devices.index')); ?>" class="bottom-nav-item <?php echo e(request()->routeIs('user.devices.*') ? 'active' : ''); ?>">
        <i class="bi bi-cpu"></i> Devices
    </a>
    <a href="<?php echo e(route('user.energy.index')); ?>" class="bottom-nav-item <?php echo e(request()->routeIs('user.energy.*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\Users\satya\OneDrive\Desktop\IOT-DASHBOARD\resources\views/layouts/app.blade.php ENDPATH**/ ?>
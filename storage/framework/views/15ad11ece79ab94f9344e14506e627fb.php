    ...
    <div class="split-layout">
        ...
        <div class="left-panel">
            <div class="header-bar fade-in-up">
                ...
                <div class="nav-text">
                    Already have an account? <a href="<?php echo e(route('login')); ?>" class="nav-link">Log In</a>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="John Doe" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 input-group-gap">
                            ...
                            <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" class="form-control" placeholder="+1 (555) 000-0000">
                        </div>
                    </div>
...
<?php /**PATH C:\Users\satya\OneDrive\Desktop\IOT-DASHBOARD\resources\views/auth/register.blade.php ENDPATH**/ ?>
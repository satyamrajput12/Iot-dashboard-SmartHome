        ...
        <div class="widget-card p-4" style="background: rgba(30, 41, 59, 0.7); border-radius: 20px; border: 1px solid var(--glass-border);">
            ...
            <div class="mb-4">
                <div class="d-flex justify-content-between">
                    ...
                    <span class="fw-bold">{{ $devicesUsed }} / {{ $deviceLimit }}</span>
                </div>
                ...
                <table class="table table-borderless text-white mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-3" style="font-family: monospace;">{{ $inv->id }}</td>
                            <td class="py-3">${{ number_format($inv->amount, 2) }}</td>
                            <td class="py-3"><span class="badge bg-success bg-opacity-25 text-success rounded-pill px-3">{{ $inv->status }}</span></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
